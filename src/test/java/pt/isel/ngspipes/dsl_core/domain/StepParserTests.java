...
public class StepParserTests {
    ...
    public void fullStepTest() throws ParserException, IOException {
        PipesParser.RootContext root = NGSPipesParser.getRootContext(readFile("stepparser/fullStep.pipes"));

        Collection<IStepDescriptor> stepsDescriptor = stepParser.parseAll(root.steps().step(), root);
    ...
    public void emptyInputsTest() throws ParserException, IOException {
        PipesParser.RootContext root = NGSPipesParser.getRootContext(readFile("stepparser/emptyInputs.pipes"));
    ...
    public void noInputsTest() throws ParserException, IOException {
        PipesParser.RootContext root = NGSPipesParser.getRootContext(readFile("stepparser/noInputs.pipes"));
    ...
    public void noExecutionContextTest() throws ParserException, IOException {
        PipesParser.RootContext root = NGSPipesParser.getRootContext(readFile("stepparser/noExecutionContext.pipes"));
